{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "9698aea7-6650-4f71-bf64-a344d325c290",
          "type": "basic.output",
          "data": {
            "name": "LEDs ",
            "range": "[1:0]",
        ...
        {
          "id": "f2e4e6ab-7464-4ea2-94d0-24825df8d970",
          "type": "basic.input",
          "data": {
            "name": "Pulsador",
            "pins": [
        ...
        {
          "id": "1b6792b0-3eb9-4235-909b-17de6d54612b",
      ...
      "wires": [
        {
          "source": {
            "block": "f2e4e6ab-7464-4ea2-94d0-24825df8d970",
            "port": "out"
          },
          "target": {
            "block": "1b6792b0-3eb9-4235-909b-17de6d54612b",
        ...
        },
        {
          ...
          "target": {
            "block": "9698aea7-6650-4f71-bf64-a344d325c290",
            "port": "in"
          },
          "size": 2
        },
