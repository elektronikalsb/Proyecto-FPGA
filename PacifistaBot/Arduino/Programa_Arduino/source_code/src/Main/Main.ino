...
#define BRAZOS_EXT 'x'
#define SENTADILLAS 's'
#define INVINCIBLE_MOD 'z'
#define ROTATE_DERECHA 'R'//EGIN GABE
#define ROTATE_IZQUIERDA 'L'//EGIN GABE
#define POS_CADERA_D 'l'//EGIN GABE
#define POS_CADERA_I 'r'//EGIN GABE
#define POS_CADERA_C 'Y'//EGIN GABE
...
#define MODO_BRAZOS_EXTENDIDO 1
#define MODO_BRAZOS_PLEGADO 2
int MODO_BRAZOS_EXT = 1;
